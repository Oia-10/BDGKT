...
def save_info_opt(dataset, batch_size, hidden_size, lr, l2, drop1, drop2,
                  layer_num, question_max_length, student_max_length, patience, gpu, cv_num,seed,
                  info_file):
    params_list = (
        'dataset = %s\n' % dataset,
        'batch_size = %d\n' % batch_size,
        ...
        'drop2 = %f\n' % drop2,
        'layer_num = %d\n' % layer_num,
        'question_max_length = %d\n' % question_max_length,
        'student_max_length = %d\n' % student_max_length,
        'patience = %d\n' % patience,
        'gpu = %s\n' % gpu,
        'cv_num = %d\n' % cv_num,
        'seed = %d\n' % seed,
